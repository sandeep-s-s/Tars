...
<div>
	...
	<div class="editor-container">
		...
		<textarea class="editor" bind:value={xmlInput} on:input={handleInput} rows="20" />
	</div>
	{#if errorMessage}
